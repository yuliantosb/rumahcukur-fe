...
import { savePermission } from '../../store/actions/permissionAction';
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    ...
                                                    {/* <div className="form-group">
                                                        ...
                                                        <AsyncSelect isClearable={true} className={error && error.data.errors.parent_id && 'is-invalid-select'} styles={customerStyles} loadOptions={parentOptions} name="parent" placeholder="Type to search ..." onChange={this.handleChangeSelect} />
                                                        { 
                                                            error && error.data.errors.name && <div className="invalid-feedback">{ error.data.errors.name[0] }</div>
                                                        }
                                                    </div> */}
...
export default connect(mapStateToProps, mapDispatchToProps)(withToastManager(AddPermission));